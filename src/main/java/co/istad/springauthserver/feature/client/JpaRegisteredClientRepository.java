...
public class JpaRegisteredClientRepository implements RegisteredClientRepository {
    ...
    public JpaRegisteredClientRepository(ClientRepository clientRepository, @Qualifier("securityObjectMapper") ObjectMapper objectMapper, PasswordEncoder passwordEncoder) {
